...
export function VideoCategoryCard({ category }: VideoCategoryCardProps) {
  return (
    <div className="w-[200px] shrink-0 snap-center rounded-2xl border border-white/5 bg-gradient-to-br from-zinc-900 to-zinc-950 p-6 transition-transform duration-500 hover:scale-[1.02]">
      <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-neon-orange/10">
        <svg className="h-5 w-5 text-neon-orange" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <p className="mt-1 text-2xl font-black text-neon-orange">
        {category.count}
      </p>
